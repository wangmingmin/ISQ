...
//    [cell setData:[listData objectAtIndex:indexPath.row]];
    ...
    cell.textLabel.text=[NSString stringWithFormat:@"%@-%@-%@-%@-%@",listData[indexPath.row][@"belongs_1"],listData[indexPath.row][@"belongs_2"],listData[indexPath.row][@"belongs_3"],listData[indexPath.row][@"belongs_4"],listData[indexPath.row][@"room"]];
    // Configure the cell...
    return cell;
}
