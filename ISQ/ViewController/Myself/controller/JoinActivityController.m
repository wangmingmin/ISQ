...
#import "JoinActivityController.h"
#import "videoCell.h"
#import "ImageCell.h"
...
@interface JoinActivityController ()<SRRefreshDelegate>{
...
- (void) loadJoinActivityData:(NSInteger )rows{
    ...
    joinDic[@"rows"] =[NSString stringWithFormat:@"%ld",(long)rows];
    [ISQHttpTool getHttp:getMyJoininActive contentType:nil params:joinDic success:^(id responseObject) {
