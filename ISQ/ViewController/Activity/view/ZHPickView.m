...
-(void)setFrameWith:(BOOL)isHaveNavControler{
    ...
    CGFloat toolViewW = UISCREENWIDTH;
...
-(void)setUpPickView{
    ...
    pickView.frame=CGRectMake(0, ZHToobarHeight, UISCREENWIDTH, pickView.frame.size.height);
...
//    NSDate* minDate = [[NSDate alloc] initWithTimeIntervalSince1970:<#(NSTimeInterval)#>
//    
...
//    datePicker.maximumDate = maxDate;
    ...
    datePicker.frame=CGRectMake(0, ZHToobarHeight, UISCREENWIDTH, datePicker.frame.size.height);
...
-(void)setToolbarWithPickViewFrame{
    _toolbar.frame=CGRectMake(0, 0,UISCREENWIDTH, ZHToobarHeight);
}
